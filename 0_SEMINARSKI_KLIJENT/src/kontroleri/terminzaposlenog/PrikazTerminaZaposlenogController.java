...
import forme.modeltabele.ModelTabeleTerminZaposlenih;
    ...
    private void addActionListeners() {
        ptz.jButtonObrisiActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (red == -1) {
                    JOptionPane.showMessageDialog(ptz, "Morate odabrati termin zaposlenog da biste ga izbrisali!", "Greska", JOptionPane.ERROR_MESSAGE);
                } else {
        ...
        ptz.jButtonAzurirajActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int red = ptz.getjTableTerminiZaposlenih().getSelectedRow();
                if (red == -1) {
                    JOptionPane.showMessageDialog(ptz, "Morate odabrati termin zaposlenog da biste ga azurirali!", "Greska", JOptionPane.ERROR_MESSAGE);
                } else {
                    ModelTabeleTerminZaposlenih mttz = (ModelTabeleTerminZaposlenih) ptz.getjTableTerminiZaposlenih().getModel();
                    ZapTermin zt = mttz.getLista().get(red);
        ...
        ptz.jButtonResetujPretraguActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ptz.getjTextFieldIme().setText("");
                ptz.getjTextFieldPrezime().setText("");
                ptz.getjComboBoxSmena().setSelectedIndex(-1);
                ptz.getjTextFieldDatumRada().setText("");
                pripremiFormu();
            }
        });
    }
